# [Fastapi Firebase](./README.md) &middot; [![GitHub license]](./LICENSE) ![Test Action]
...
```shell
git clone https://github.com/SimonTheDeveloper/fastapi-firebase.git
```
...
[test action]: https://github.com/SimonTheDeveloper/fastapi-firebase/actions/workflows/test.yaml/badge.svg
